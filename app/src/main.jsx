            ...
            <div>
                <div id="leftMenu"> 
                    ...
                    <Menu onClick={this.handleClick}
                        ...
                        mode="inline">
                        <Menu.Item key="1">                    
                            <IndexLink to="/init"><span><Icon type="home" /><span>欢迎页</span></span></IndexLink>
                        </Menu.Item>
                        ...
                        <SubMenu key="sub3" title={<span><Icon type="bar-chart" /><span>导航二</span></span>}>
                            <Menu.Item key="3"><Link to="/init/antdes">子导航二</Link></Menu.Item>
                        </SubMenu>
                        <SubMenu key="sub4" title={<span><Icon type="appstore" /><span>导航三</span></span>}>
                            <Menu.Item key="4"><Link to="/init/gallery">子导航三</Link></Menu.Item>
                            <Menu.Item key="5"><Link to="/init/subpage">子导航四</Link></Menu.Item>
                        </SubMenu>
                        <Menu.Item key="6">
                            <Link to="/ini/last"><span><Icon type="solution" /><span>结尾页</span></span></Link>
                        </Menu.Item>
                    </Menu>                    
                </div>
                <div id="rightWrap">
